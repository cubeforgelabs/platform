...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-1.5 text-text-dim hover:text-text transition-colors cursor-pointer"
    >
      {/* Sun icon */}
      <svg
        width="13"
      ...
      <div className="relative w-9 h-5 rounded-full border border-border2 bg-surface2 transition-colors">
        <div
          className={`absolute top-0.5 w-4 h-4 rounded-full bg-accent transition-all duration-200 ${
