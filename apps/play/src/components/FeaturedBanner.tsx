  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col md:flex-row items-center gap-8 p-8 md:p-12">
        {/* Game preview */}
        <div
          className="w-full md:w-80 aspect-[16/10] rounded-xl border border-border/50 flex items-center justify-center shrink-0"
          style={{ background: `${game.color}08` }}
        >
          <span
            className="text-7xl font-bold font-mono opacity-15 group-hover:opacity-25 transition-opacity"
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="text-sm text-text-dim mb-1">by {game.author}</p>
          <p className="text-sm text-text-dim leading-relaxed mb-5 max-w-md">
            {game.description}
          </p>

          <div className="flex items-center gap-4 justify-center md:justify-start">
            <span
              className="inline-flex items-center gap-2 rounded-xl px-6 py-2.5 text-sm font-semibold text-bg group-hover:opacity-90 transition-opacity"
              style={{ background: game.color }}
            >
              <svg
                width="16"
