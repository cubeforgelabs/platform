    ...
    return (
      <div className="min-h-screen bg-bg flex items-center justify-center px-4">
        <div className="text-center max-w-sm">
          <div className="w-12 h-12 rounded-2xl bg-surface2 border border-border flex items-center justify-center mx-auto mb-4">
            <span className="text-green text-xl">✓</span>
          </div>
          <h2 className="text-text font-semibold mb-2">Check your email</h2>
          <p className="text-sm text-text-dim">We sent a confirmation link to <strong className="text-text">{email}</strong>. Click it to activate your account.</p>
          <Link to="/signin" className="mt-6 inline-block text-xs text-accent hover:underline">Back to sign in</Link>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-bg flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-lg font-semibold text-text mt-4">Create an account</h1>
        </div>
