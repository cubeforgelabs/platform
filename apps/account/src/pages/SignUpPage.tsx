    ...
    return (
      <div className="min-h-screen bg-bg flex items-center justify-center px-4 relative">
        ...
        <div className="text-center max-w-sm relative z-10 fade-up">
          ...
          >
            <Check size={20} color="#a6e3a1" strokeWidth={2.5} />
          </div>
          ...
          <Link
            to="/signin"
            className="mt-5 inline-flex items-center gap-1.5 text-xs text-text-muted hover:text-text transition-colors"
          >
            <ArrowLeft size={12} />
            Back to sign in
          </Link>
        ...
        <div className="rounded-xl overflow-hidden" style={{ border: '1px solid var(--border)', background: 'rgba(19,21,31,0.9)', backdropFilter: 'blur(12px)' }}>
          ...
          <form onSubmit={handleSubmit} className="p-5 pt-4 flex flex-col gap-2.5">
            ...
            <p className="text-center text-xs text-text-muted pt-0.5">
              ...
              <Link to="/signin" className="text-accent hover:text-accent2 transition-colors">Sign in</Link>
            </p>
          </form>
        </div>
      </div>
