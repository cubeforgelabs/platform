    ...
    <div className="min-h-screen bg-bg flex items-center justify-center px-4 py-10 relative">
      ...
      <div className="w-full max-w-[400px] relative z-10 fade-up">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold text-text tracking-tight">Create an account</h1>
          <p className="text-sm text-text-dim mt-1.5">Build and share your games</p>
        </div>
          ...
          <CardContent className="px-6 pt-0 pb-6">
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <p className="text-center text-sm text-text-muted pt-1">
                ...
                <Link to="/signin" className="text-text underline hover:text-accent transition-colors">
                  Sign in
                </Link>
              </p>
            </form>
